# Sieve Build System v2 - Rules Legend

The v2 build system aggregates rules from `rules.txt` files located in `sieve/lists/<rule>/`. Each line in these files uses a semantic DSL (Domain Specific Language) to define how the rule should be processed.
